    ...
    <div class="container">
        <div class="row">
            <div class="col-md-9 p-3" style="background-color:#eaeded">
                <div class="card">
                    <div class="card-header" style="background-color: brown;color:white;"><strong>Iniciar sesión</strong>
                    </div>
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="row mb-3">
                                <label for="email" class="col-md-4 col-form-label text-md-end"><strong>Correo
                            ...
                            <div class="row mb-3">
                                <label for="password"
                                    class="col-md-4 col-form-label text-md-end"><strong>Contraseña</strong></label>
